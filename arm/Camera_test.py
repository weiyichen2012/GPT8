...
if __name__ == '__main__':
    hands = mediapipe.solutions.hands.Hands(static_image_mode=False, min_detection_confidence=0.7, min_tracking_confidence=0.7, max_num_hands=2)
        ...
        if frame is not None:
            ...
            if results.multi_hand_landmarks != None:
                for handLandmarks in results.multi_hand_landmarks:
                    mediapipe.solutions.drawing_utils.draw_landmarks(frame1, handLandmarks, mediapipe.solutions.hands.HAND_CONNECTIONS)
